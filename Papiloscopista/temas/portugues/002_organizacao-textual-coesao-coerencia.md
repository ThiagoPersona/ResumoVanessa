...
Este capítulo existe para cobrir, sem desvio, o recorte do edital em **Língua Portuguesa 1.2-1.3**. O estudo deve começar pelo vocabulário central, avançar para diferenças cobradas em alternativa e terminar com resolução de questão.
...
- **Organização estrutural dos textos.** Transforme o conceito em função no texto: coesão, progressão temática, sentido, registro e correção.
- **Marcas de textualidade: coesão, coerência e intertextualidade.** Transforme o conceito em função no texto: coesão, progressão temática, sentido, registro e correção.
