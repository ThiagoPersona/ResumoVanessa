...
- **Frequência no edital:** a disciplina Português soma 25 questões; este capítulo concentra Língua Portuguesa 1.1.
...
Este capítulo existe para cobrir, sem desvio, o recorte do edital em **Língua Portuguesa 1.1**. O estudo deve começar pelo vocabulário central, avançar para diferenças cobradas em alternativa e terminar com resolução de questão.
...
- **Interpretação e compreensão de texto.** Revise com perguntas de comando: ideia central, inferência, pressuposto, referente, efeito de sentido e finalidade do trecho.
...
- [ ] Li o item do edital correspondente: Língua Portuguesa 1.1.
