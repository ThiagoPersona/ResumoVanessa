...
|---|---:|---|
| FGV PC-PI | 2026 | Q1: diferenciar identificação comparativa de reconstrutiva, e reconhecer o papel do anel pélvico. Q2: definição técnica de identificação comparativa. |
| FGV PC-MG | 2025 | Q10: identificar a afirmativa incorreta sobre a classificação de Vucetich (posição do delta). |
| FGV PC-AM | 2022 | Q19: fundamentos biológicos x técnicos da identificação papiloscópica. Q20: montagem da fórmula dactiloscópica de Vucetich. |
...
### Identificação comparativa x identificação reconstrutiva (estimativa)

A FGV testa uma distinção fina dentro do próprio processo de identificação:

- **Identificação comparativa**: confronta um registro **ante mortem** (documento, prontuário odontológico, ficha datiloscópica, exame médico anterior) com dados **post mortem** obtidos do corpo ou vestígio, buscando coincidência. Exige que exista um registro prévio da pessoa suspeita para comparar.
- **Identificação reconstrutiva (ou estimativa)**: infere o **perfil biológico** do indivíduo desconhecido (sexo, idade aproximada, ancestralidade, estatura) a partir dos próprios restos, **sem** um registro prévio específico para comparar — apenas estreita o universo de possibilidades, não aponta uma pessoa específica.

Erro clássico de prova: inverter os dois conceitos, dizendo que a comparativa "estima perfil biológico" (isso é reconstrutiva) ou que a reconstrutiva "depende de ante mortem para comparar" (isso é comparativa).

A viabilidade da necropapiloscopia (colher impressões digitais de um cadáver) segue a lógica oposta ao que a intuição sugere: é mais viável **no início** do processo de decomposição (a pele ainda preserva as cristas papilares) e se torna difícil ou inviável **conforme a putrefação avança** (a pele se degrada, descola ou se destrói).
...
### Fundamentos biológicos x fundamentos técnicos da identificação papiloscópica

Para que um processo de identificação seja considerado cientificamente aceitável, a doutrina exige cinco requisitos, divididos em dois grupos:

| Grupo | Fundamentos | O que garantem |
|---|---|---|
| Biológicos (propriedade do próprio desenho papilar) | Individualidade (unicidade), imutabilidade, perenidade | Que o desenho é único, não muda e dura a vida toda |
| Técnicos (viabilidade prática do sistema) | Classificabilidade, praticabilidade | Que o desenho pode ser classificado, arquivado e comparado de forma eficiente |

Erro clássico de prova: misturar um fundamento técnico (classificabilidade, praticabilidade) dentro de uma lista que pede exclusivamente os fundamentos biológicos, ou vice-versa.

### A fórmula dactiloscópica de Vucetich

A fórmula organiza a classificação dos dez dedos das duas mãos em dois blocos:

- **Série** (mão direita): letra-prefixo dada pelo tipo do polegar direito (A=arco, I=presilha interna, E=presilha externa, V=verticilo), seguida de quatro dígitos correspondentes aos demais dedos (indicador, médio, anular, mínimo), na ordem.
- **Secção** (mão esquerda): mesma lógica, com o polegar esquerdo definindo a letra-prefixo.

Cada tipo fundamental recebe um valor numérico fixo para compor os quatro dígitos: arco = 1, presilha interna = 2, presilha externa = 3, verticilo = 4; um dedo amputado recebe o valor 0. Erro clássico de prova: trocar a ordem dos dedos ao montar os dígitos, ou inverter qual mão corresponde à Série e qual corresponde à Secção.
...
**Fonte: FGV, PC-PI, 2026, questão 1 (gabarito oficial: E)**

> Sobre a identificação humana, assinale a opção correta.
>
> (A) A identificação reconstrutiva depende de informações ante mortem para comparação com as informações post mortem obtidas.
> (B) A identificação comparativa é feita através da estimativa do perfil biológico.
> (C) A análise do DNA é o único método seguro de identificação.
> (D) A identificação necropapiloscópica não pode ser feita em cadáveres no início da fase de putrefação.
> (E) Os ossos do anel pélvico são extremamente úteis no processo de identificação para estimativa de idade e sexo do indivíduo.

1. **A e B invertem os conceitos de comparativa e reconstrutiva** — quem depende de ante/post mortem é a comparativa; quem estima perfil biológico é a reconstrutiva.
2. **C é afirmação absoluta e falsa**; existem outros métodos aceitos conforme o contexto.
3. **D inverte a lógica da putrefação**: a necropapiloscopia é mais viável no início da putrefação, não menos.
4. **E é o gabarito**, descrição correta do papel do anel pélvico.

**Fonte: FGV, PC-MG, 2025, questão 10 (gabarito oficial: E)**

> Sobre a identificação judiciária por papiloscopia, segundo Vucetich, assinale a afirmativa incorreta.
>
...
> (E) A figura delta não é considerada nos tipos fundamentais dos padrões observados nas impressões digitais.

1. **A, B, C e D descrevem corretamente o papel do delta em cada tipo fundamental**.
2. **E nega esse papel central**, contrariando o próprio critério que define a classificação.
3. **E é o gabarito** (a alternativa incorreta pedida pelo comando).

**Fonte: FGV, PC-AM, 2022, questão 19 (gabarito oficial: D)**

> Assinale a opção que indica apenas os fundamentos biológicos do processo de identificação.
>
> (A) unicidade, perenidade e praticabilidade.
> (B) unicidade, imutabilidade e classificabilidade.
> (C) perenidade, imutabilidade e praticabilidade.
> (D) individualidade, imutabilidade e perenidade.
> (E) classificabilidade, praticabilidade e unicidade.

1. **Separe fundamento biológico (propriedade do desenho em si) de fundamento técnico (viabilidade prática do sistema)**.
2. **A, B, C e E misturam "praticabilidade" e/ou "classificabilidade"** (técnicos) com fundamentos biológicos.
3. **D reúne exclusivamente os três biológicos**: individualidade, imutabilidade e perenidade.
4. **D é o gabarito.**

**Fonte: FGV, PC-AM, 2022, questão 20 (gabarito oficial: A)**

> Considere: Mão direita: polegar (arco); indicador (arco); médio (presilha externa); anular (verticilo); mínimo (presilha interna). Mão esquerda: polegar (verticilo); indicador (presilha interna); médio (verticilo); anular (arco); mínimo (amputado). Assinale a fórmula dactiloscópica correta.
>
> (A) Série: A 1 3 4 2 / Secção: V 2 4 1 0.
> (B) Série: A 4 3 1 2 / Secção: V 2 1 4 0.
> (C) Série: A 1 3 4 2 / Secção: V 2 4 1 X.
> (D) Secção: A 4 3 1 2 / Série: V 2 1 4 X.
> (E) Secção: 1 1 3 4 2 / Série: 4 2 4 1 0.

1. **Monte a Série (mão direita)**: prefixo pelo polegar (arco → A); dígitos por indicador, médio, anular, mínimo (arco=1, presilha externa=3, verticilo=4, presilha interna=2) → A 1 3 4 2.
2. **Monte a Secção (mão esquerda)**: prefixo pelo polegar (verticilo → V); dígitos (presilha interna=2, verticilo=4, arco=1, amputado=0) → V 2 4 1 0.
3. **A é o gabarito**, única com Série e Secção corretas.
...
- Inverter identificação comparativa (confronta ante/post mortem) com reconstrutiva (estima perfil biológico sem comparar).
- Achar que a necropapiloscopia fica mais fácil com o avanço da putrefação (é o contrário: fica mais difícil).
- Misturar fundamento biológico (individualidade, imutabilidade, perenidade) com fundamento técnico (classificabilidade, praticabilidade).
- Errar a ordem dos dedos ou trocar Série (mão direita) por Secção (mão esquerda) ao montar a fórmula dactiloscópica.
...
- Ainda não há questão real localizada sobre pontos característicos (minúcias) especificamente, nem sobre AFIS/biometria digital aplicada à papiloscopia — a teoria está coberta acima, falta a camada de prática com questão real conferida.
...
- [ ] Sei diferenciar identificação comparativa de reconstrutiva (estimativa).
- [ ] Sei diferenciar fundamento biológico de fundamento técnico da identificação.
- [ ] Sei montar a fórmula dactiloscópica de Vucetich (Série e Secção).
...
- FGV. PC-PI, 2026. Questões 1 e 2 localizadas em banco de questões (qconcursos), com gabarito oficial da banca.
- FGV. PC-MG, 2025. Questão 10 localizada em banco de questões (qconcursos), com gabarito oficial da banca.
- FGV. PC-AM, 2022. Questões 19 e 20 localizadas em banco de questões (qconcursos), com gabarito oficial da banca.
