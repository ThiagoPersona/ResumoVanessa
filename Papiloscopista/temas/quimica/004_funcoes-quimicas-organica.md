...
> **Base do edital:** Conhecimentos Específicos; Química 5.4.  
> **Peso da disciplina:** 5 questões na prova objetiva.  
> **Prioridade:** alta.

## Por que cai

- **Frequência no edital:** a disciplina Química soma 5 questões; este capítulo concentra Química 5.4.
...
Este capítulo existe para cobrir, sem desvio, o recorte do edital em **Química 5.4**. O estudo deve começar pelo vocabulário central, avançar para diferenças cobradas em alternativa e terminar com resolução de questão.

- Reagente pericial deve ser compatível com superfície, resíduo e método de visualização; alternativa absoluta costuma ser suspeita.
...
- **Ácidos, bases, sais e óxidos.** Classifique substância, mistura, reação ou função química e conecte ao uso pericial quando houver reagentes e resíduos.
- **Compostos orgânicos, funções orgânicas e propriedades físicas e químicas.** Classifique substância, mistura, reação ou função química e conecte ao uso pericial quando houver reagentes e resíduos.
...
- [ ] Li o item do edital correspondente: Química 5.4.
