...
> **Base do edital:** Conhecimentos Específicos; Química 5.1.  
> **Peso da disciplina:** 5 questões na prova objetiva.  
> **Prioridade:** média.

## Por que cai

- **Frequência no edital:** a disciplina Química soma 5 questões; este capítulo concentra Química 5.1.
...
Este capítulo existe para cobrir, sem desvio, o recorte do edital em **Química 5.1**. O estudo deve começar pelo vocabulário central, avançar para diferenças cobradas em alternativa e terminar com resolução de questão.
...
- **Modelos atômicos, estrutura do átomo e elementos químicos.** Classifique substância, mistura, reação ou função química e conecte ao uso pericial quando houver reagentes e resíduos.
- **Classificação periódica e ligações químicas.** Classifique substância, mistura, reação ou função química e conecte ao uso pericial quando houver reagentes e resíduos.
...
- [ ] Li o item do edital correspondente: Química 5.1.
