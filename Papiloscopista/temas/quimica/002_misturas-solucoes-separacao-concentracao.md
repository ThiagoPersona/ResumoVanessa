...
Este capítulo existe para cobrir, sem desvio, o recorte do edital em **Química 5.2**. O estudo deve começar pelo vocabulário central, avançar para diferenças cobradas em alternativa e terminar com resolução de questão.
...
- **Misturas e métodos de separação.** Classifique substância, mistura, reação ou função química e conecte ao uso pericial quando houver reagentes e resíduos.
- **Soluções, concentração e solubilidade.** Classifique substância, mistura, reação ou função química e conecte ao uso pericial quando houver reagentes e resíduos.
