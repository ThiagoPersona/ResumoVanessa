...
Este capítulo existe para cobrir, sem desvio, o recorte do edital em **RLM 2.6-2.7, 2.9-2.10, 2.13**. O estudo deve começar pelo vocabulário central, avançar para diferenças cobradas em alternativa e terminar com resolução de questão.
...
- **Associações arbitrárias entre pessoas, lugares, objetos ou eventos fictícios.** Traduza o enunciado para tabela, proposição, diagrama ou equação simples.
- **Dedução de informações e avaliação de condições.** Traduza o enunciado para tabela, proposição, diagrama ou equação simples.
- **Raciocínio verbal, matemático e sequencial; orientação espacial e temporal.** Traduza o enunciado para tabela, proposição, diagrama ou equação simples.
- **Problemas aritméticos, geométricos e matriciais.** Traduza o enunciado para tabela, proposição, diagrama ou equação simples.
- **Contagem, noções de probabilidade e problemas de lógica.** Liste casos possíveis e casos favoráveis, separando eventos dependentes e independentes.
