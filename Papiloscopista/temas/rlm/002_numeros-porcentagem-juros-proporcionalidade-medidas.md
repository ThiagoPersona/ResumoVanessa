...
> **Base do edital:** Conhecimentos Gerais; RLM 2.3-2.5.  
> **Peso da disciplina:** 5 questões na prova objetiva.  
> **Prioridade:** alta.

## Por que cai

- **Frequência no edital:** a disciplina RLM soma 5 questões; este capítulo concentra RLM 2.3-2.5.
...
- **Números inteiros, racionais e reais.** Frações, decimais, razão, proporção, regra de três, porcentagem, pontos percentuais, juros simples/compostos, escalas e conversões.
- **Porcentagem, juros simples e compostos.** Frações, decimais, razão, proporção, regra de três, porcentagem, pontos percentuais, juros simples/compostos, escalas e conversões.
- **Razões, proporções, regra de três e sistemas de medidas.** Frações, decimais, razão, proporção, regra de três, porcentagem, pontos percentuais, juros simples/compostos, escalas e conversões.
...
**O que significa:** Números, porcentagem, juros e medidas exigem controle de base, unidade e proporção. Juros simples crescem linearmente; juros compostos crescem sobre montante acumulado.

**Como estudar para a prova:** Frações, decimais, razão, proporção, regra de três, porcentagem, pontos percentuais, juros simples/compostos, escalas e conversões.

**Como a FGV pode cobrar:** A FGV cobra problema curto com base implícita ou duas etapas de aumento/desconto.

**Cuidado de prova:** Aumento de 20% seguido de desconto de 20% não volta ao valor inicial.

### 2. Porcentagem, juros simples e compostos.
...
### 3. Razões, proporções, regra de três e sistemas de medidas.
...
|---|---|---|
| Números inteiros, racionais e reais. | Aumento de 20% seguido de desconto de 20% não volta ao valor inicial. | A FGV cobra problema curto com base implícita ou duas etapas de aumento/desconto. |
| Porcentagem, juros simples e compostos. | Aumento de 20% seguido de desconto de 20% não volta ao valor inicial. | A FGV cobra problema curto com base implícita ou duas etapas de aumento/desconto. |
| Razões, proporções, regra de três e sistemas de medidas. | Aumento de 20% seguido de desconto de 20% não volta ao valor inicial. | A FGV cobra problema curto com base implícita ou duas etapas de aumento/desconto. |
...
|---|---|---|
| Números inteiros, racionais e reais. | Frações, decimais, razão, proporção, regra de três, porcentagem, pontos percentuais, juros simples/compostos, escalas e conversões. | Aumento de 20% seguido de desconto de 20% não volta ao valor inicial. |
| Porcentagem, juros simples e compostos. | Frações, decimais, razão, proporção, regra de três, porcentagem, pontos percentuais, juros simples/compostos, escalas e conversões. | Aumento de 20% seguido de desconto de 20% não volta ao valor inicial. |
| Razões, proporções, regra de três e sistemas de medidas. | Frações, decimais, razão, proporção, regra de três, porcentagem, pontos percentuais, juros simples/compostos, escalas e conversões. | Aumento de 20% seguido de desconto de 20% não volta ao valor inicial. |
...
- [ ] Li o item do edital correspondente: RLM 2.3-2.5.
