...
Este capítulo existe para cobrir, sem desvio, o recorte do edital em **Física 4.4**. O estudo deve começar pelo vocabulário central, avançar para diferenças cobradas em alternativa e terminar com resolução de questão.
...
- **Fundamentos físicos da captura de imagens e fotografia digital.** Relacione fenômeno físico ao equipamento usado: iluminação, formação da imagem, sensor, circuito ou fluorescência.
- **Sistemas biométricos e equipamentos ópticos e eletrônicos aplicados à identificação humana.** Relacione fenômeno físico ao equipamento usado: iluminação, formação da imagem, sensor, circuito ou fluorescência.
