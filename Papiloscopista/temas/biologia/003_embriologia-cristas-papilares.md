...
Este capítulo existe para cobrir, sem desvio, o recorte do edital em **Biologia 3.3**. O estudo deve começar pelo vocabulário central, avançar para diferenças cobradas em alternativa e terminar com resolução de questão.
...
- **Gametogênese, fecundação e desenvolvimento embrionário.** Estude estrutura, função e aplicação na identificação humana, especialmente quando o edital menciona impressão digital ou biometria.
- **Formação das cristas papilares.** Estude estrutura, função e aplicação na identificação humana, especialmente quando o edital menciona impressão digital ou biometria.
