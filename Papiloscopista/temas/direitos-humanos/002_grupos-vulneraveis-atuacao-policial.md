...
Este capítulo existe para cobrir, sem desvio, o recorte do edital em **Direitos Humanos 10.4-10.5**. O estudo deve começar pelo vocabulário central, avançar para diferenças cobradas em alternativa e terminar com resolução de questão.
...
- **Mulheres, idosos, crianças e adolescentes, povos indígenas e comunidades tradicionais, pessoas com deficiência, população LGBTQIA+ e refugiados.** Conecte princípio, sistema de proteção, grupo vulnerável e padrão de atuação policial.
- **Dignidade humana, uso proporcional da força, prevenção da tortura, direitos da pessoa presa e atuação policial.** Conecte princípio, sistema de proteção, grupo vulnerável e padrão de atuação policial.
