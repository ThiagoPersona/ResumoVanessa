# Questões - Tanatologia, necropsia, toxicologia e psicopatologia
...
<label class="quiz-option"><input type="radio" name="fgv-022" value="C"> C. a substituir integralmente a necropsia.</label>
<label class="quiz-option"><input type="radio" name="fgv-022" value="D"> D. a dispensar cadeia de custódia.</label>
<label class="quiz-option"><input type="radio" name="fgv-022" value="E"> E. a determinar automaticamente autoria do crime.</label>
</div>
<button class="quiz-check" type="button">Checar resposta</button>
<div class="quiz-feedback" hidden>
<p><strong>Resposta: B.</strong> Questão autoral no padrão FGV; não é reprodução literal de caderno oficial.</p>
<p><strong>Como pensar:</strong> Tanatologia cobra sequência e utilidade dos fenômenos cadavéricos.</p>
<p><strong>Por que a alternativa correta está certa:</strong> Esses fenômenos ajudam na análise cronotanatológica.</p>
<ul class="quiz-explain">
<li><strong>A.</strong> Incorreta. Identidade civil exige outros métodos.</li>
<li><strong>B.</strong> Correta. São sinais úteis para estimar circunstâncias pós-morte.</li>
<li><strong>C.</strong> Incorreta. Não substituem necropsia quando necessária.</li>
<li><strong>D.</strong> Incorreta. Vestígios relacionados ao corpo também precisam de preservação.</li>
<li><strong>E.</strong> Incorreta. Fenômeno cadavérico não identifica autor automaticamente.</li>
</ul>
<p><strong>Pegadinha principal:</strong> Confundir causa, tempo e autoria.</p>
</div>
</div>
